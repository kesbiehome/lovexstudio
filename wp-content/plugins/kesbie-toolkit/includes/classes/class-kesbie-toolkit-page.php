 ...
 * @subpackage Kesbie_Toolkit_Page
 * @since   1.0.0
 * @author  CODE TOT JSC <dev@codetot.com>
 */
class Kesbie_Toolkit_Page
{

    /**
     * Singleton instance
     *
     * @var Kesbie_Toolkit_Page
     */
    ...
    {
        return apply_filters('kesbie_layout_fields', []);
    }
            ...
            acf_add_local_field_group(array(
                ...
                'fields' => array(
                    array(
                        ...
                        'button_label' => esc_html__('Add Block', 'kesbie-toolkit'),
                        'min' => '',
                        'max' => '',
                    ),
                ),
        ...
        if (!empty($template_slug) && $template_slug == 'flexible') {
            ...
            if (have_rows('blocks')) {
                while (have_rows('blocks')) {
                    ...
                    do_action('kesbie_flexible_page_row', get_row_index(), get_row_layout());
                }
            }
