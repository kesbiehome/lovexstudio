...
function get_project_by_term_id($term_ids, $options = [], $posts_per_page = 6, $paged = 1)
{
    $default_args = [
        'post_type' => 'project',
        'fields' => 'ids',
    ...
    $project_args = wp_parse_args($options, $default_args);
    $project_args['posts_per_page'] = $posts_per_page;
    $project_args['paged'] = $paged;
    $project_args['tax_query'] = [
        [
